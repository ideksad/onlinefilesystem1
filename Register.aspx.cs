...
namespace onlinefilesystem1
{
    public partial class _Default : Page
    {
        ...
        protected void btnSave_Click1(object sender, EventArgs e)
        {
            ...
            strConnString = "Server=localhost;Uid=sa;PASSWORD=1234;database=filesystem;Max Pool Size=400;Connect Timeout=600;";
            ...
            try
            {
                ...
                Response.Write("<script>alert('Register Complete ! Go to LoginPage') ; location.href='Default.aspx'</script>");
